...
class Entity_Type():
    entity_type={
        ...
        "Safe_Write_Count":GEType("sensor","number","",0,1000000,False,False,False),
        ...
        "Battery_Throughput_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "PV_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Import_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Export_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "AC_Charge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Invertor_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Battery_Charge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Battery_Discharge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Self_Consumption_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Load_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        ...
        "PV_Voltage_String_1":GEType("sensor","voltage","",0,1000,True,False,False),
        "PV_Voltage_String_2":GEType("sensor","voltage","",0,1000,True,False,False),
        ...
        "Invertor_Temperature":GEType("sensor","temperature","",'-maxTemp','maxTemp',False,True,False),
        ...
        "Real_Time_Control":GEType("switch","","enableRTC","","",False,False,False),
        ...
        "Sync_Time":GEType("button","","syncDateTime","","",False,False,False),
        ...
        "Stack_Discharge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',True,True,True),
        "Stack_Charge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',True,True,True),
    ...
    ### EMS ###
        ...
        "Export_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Inverter_In_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Inverter_Out_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Generation_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Parallel_Total_Charge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "Parallel_Total_Charge_Energy_Total_kWh":GEType("sensor","energy","",0,'maxTotalEnergy',False,False,True),
        "Parallel_Total_Discharge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
    ...
    ### ThreePhase ###
        "Export2_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "PV1_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "PV_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
    ...
    ### Gateway ###
        ...
        "AC_Discharge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
        "AC_Charge_Energy_Today_kWh":GEType("sensor","energy","",0,'maxTodayEnergy',False,True,True),
