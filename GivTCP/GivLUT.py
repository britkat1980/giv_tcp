...
class GivLUT:
    ...
    logging.basicConfig(format='%(asctime)s - '+ str(GiV_Settings.ha_device_prefix)+ \
...
## Remove Raw from regCache??
    ...
    modes=["Eco","Eco (Paused)","Timed Demand","Timed Export","Unknown","Export (Paused)"]
    rates=["Day","Night"]
    ...
    battery_calibration=['Off','Start','Charge Only',"Running"]
